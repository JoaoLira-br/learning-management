...
const CourseEditor = () => {
  ...
  // methods is an object that contains all the functions that we need to interact with the form especially shadcn
  ...
  const onSubmit = async (data: CourseFormData) => {
    try {
      const updatedSections = await uploadAllVideos(
        sections,
        id,
        // this is essential since api gateway does not accept videos over 10mb
        getUploadVideoUrl
      );
